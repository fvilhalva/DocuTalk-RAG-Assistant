...
disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=['Grupo A', 'Grupo B'])
...
nx.draw(G, pos, with_labels=True, node_color=y_pred, cmap=plt.cm.coolwarm, node_size=300)
